<?php
	...
	if(isset($_REQUEST['login'])){
		...
		$pass=$_REQUEST['pass'];
		$q1="select * from faculty_mst where fname='$uname' && password='$pass'";
		$e1=$conn->query($q1);
		$_SESSION['utype']="f";
				...
				<div class="animate form login_form">
					...
					<section class="login_content">
						<form method="post">
							...
							<div class="separator">
								<p class="change_link">FACULTY LOGIN
								...
								<button type="submit" class="btn btn-default submit" name="login" onclick="location.href= 'sadlogin.php'">Sub-Admin Login</button>
								<!-- <a class="reset_pass" href="#">Lost your password?</a> -->
								</div>
							</div>
						</form>
